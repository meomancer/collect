package org.scan.collect.android.tasks.sms;
...
import org.scan.collect.android.dao.InstancesDao;
import org.scan.collect.android.events.RxEventBus;
import org.scan.collect.android.events.SmsRxEvent;
import org.scan.collect.android.jobs.SmsSenderJob;
...
import org.scan.collect.android.provider.InstanceProviderAPI;
import org.scan.collect.android.tasks.InstanceUploader;
import org.scan.collect.android.tasks.sms.contracts.SmsSubmissionManagerContract;
import org.scan.collect.android.tasks.sms.models.Message;
import org.scan.collect.android.tasks.sms.models.SmsProgress;
import org.scan.collect.android.tasks.sms.models.SmsSubmission;
import org.scan.collect.android.utilities.ArrayUtils;
...
import static org.scan.collect.android.tasks.sms.SmsNotificationReceiver.SMS_NOTIFICATION_ACTION;
import static org.scan.collect.android.tasks.sms.SmsSender.SMS_INSTANCE_ID;
import static org.scan.collect.android.tasks.sms.SmsSender.SMS_MESSAGE_ID;
import static org.scan.collect.android.tasks.sms.SmsSender.SMS_RESULT_CODE;
import static org.scan.collect.android.tasks.sms.SmsSender.checkIfSentIntentExists;
import static org.scan.collect.android.utilities.FileUtil.getFileContents;
import static org.scan.collect.android.utilities.FileUtil.getSmsInstancePath;
