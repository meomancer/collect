...
import org.scan.collect.android.BuildConfig;
import org.scan.collect.android.R;
import org.scan.collect.android.adapters.IconMenuListAdapter;
import org.scan.collect.android.adapters.model.IconMenuItem;
import org.scan.collect.android.application.Collect;
import org.scan.collect.android.dao.FormsDao;
import org.scan.collect.android.dao.helpers.ContentResolverHelper;
import org.scan.collect.android.dao.helpers.FormsDaoHelper;
import org.scan.collect.android.dao.helpers.InstancesDaoHelper;
import org.scan.collect.android.exception.GDriveConnectionException;
import org.scan.collect.android.exception.JavaRosaException;
import org.scan.collect.android.external.ExternalDataManager;
import org.scan.collect.android.fragments.dialogs.CustomDatePickerDialog;
import org.scan.collect.android.fragments.dialogs.NumberPickerDialog;
import org.scan.collect.android.fragments.dialogs.RankingWidgetDialog;
import org.scan.collect.android.listeners.AdvanceToNextListener;
import org.scan.collect.android.listeners.FormLoaderListener;
import org.scan.collect.android.listeners.FormSavedListener;
import org.scan.collect.android.listeners.PermissionListener;
import org.scan.collect.android.listeners.SavePointListener;
import org.scan.collect.android.logic.FormController;
import org.scan.collect.android.logic.FormController.FailedConstraint;
import org.scan.collect.android.logic.FormInfo;
import org.scan.collect.android.preferences.AdminKeys;
import org.scan.collect.android.preferences.AdminSharedPreferences;
import org.scan.collect.android.preferences.GeneralSharedPreferences;
import org.scan.collect.android.preferences.PreferenceKeys;
import org.scan.collect.android.preferences.PreferencesActivity;
import org.scan.collect.android.provider.FormsProviderAPI.FormsColumns;
import org.scan.collect.android.provider.InstanceProviderAPI.InstanceColumns;
import org.scan.collect.android.tasks.FormLoaderTask;
import org.scan.collect.android.tasks.SaveFormIndexTask;
import org.scan.collect.android.tasks.SavePointTask;
import org.scan.collect.android.tasks.SaveResult;
import org.scan.collect.android.tasks.SaveToDiskTask;
import org.scan.collect.android.utilities.ActivityAvailability;
import org.scan.collect.android.utilities.ApplicationConstants;
import org.scan.collect.android.utilities.DependencyProvider;
import org.scan.collect.android.utilities.DialogUtils;
import org.scan.collect.android.utilities.FileUtils;
import org.scan.collect.android.utilities.ImageConverter;
import org.scan.collect.android.utilities.MediaManager;
import org.scan.collect.android.utilities.MediaUtils;
import org.scan.collect.android.utilities.SoftKeyboardUtils;
import org.scan.collect.android.utilities.TimerLogger;
import org.scan.collect.android.utilities.ToastUtils;
import org.scan.collect.android.views.ODKView;
import org.scan.collect.android.widgets.DateTimeWidget;
import org.scan.collect.android.widgets.QuestionWidget;
import org.scan.collect.android.widgets.RangeWidget;
import org.scan.collect.android.widgets.StringWidget;
...
import static org.scan.collect.android.preferences.AdminKeys.KEY_MOVING_BACKWARDS;
import static org.scan.collect.android.utilities.ApplicationConstants.RequestCodes;
import static org.scan.collect.android.utilities.PermissionUtils.checkIfStoragePermissionsGranted;
import static org.scan.collect.android.utilities.PermissionUtils.finishAllActivities;
import static org.scan.collect.android.utilities.PermissionUtils.requestStoragePermissions;
